...
export const INITIAL_MOVIES: Movie[] = [
  ...
  },
  {
    ...
    description: "T'Challa yegukana ingoma ya Wakanda nyuma y'urupfu rwa se. Agomba guhangana n'umwanzi uri mu muryango we ushaka gukoresha ikoranabuhanga rya Wakanda mu rwego rwo guteza intambara ku isi yose. Ni filime yerekana ubwiza bwa Afurika n'ubutwari budasanzwe.",
    year: '2018',
    rating: '8.3',
    duration: '2h 14min',
    views: '5M',
  ...
  },
  {
    ...
    title: 'The Lion King',
    category: 'african',
    poster: '/src/assets/images/lion_king_poster_final_1779179227658.png',
    description: "Inkuru y'akanyamasyo k'intare Simba kagerageza kwisubiza intebe y'ubwami yabambuwe na se-wabo Scar nyuma y'urupfu rw'agahinda rwa se Mufasa. Simba agomba kwimenyereza kubaho mu mashyamba kugeza igihe agarukiye guhangana n'amateka ye. Ni filime irimo indirimbo n'uburanga bw'ubutayu.",
    year: '2019',
    rating: '6.9',
    duration: '1h 58min',
    views: '15M',
    director: 'Jon Favreau',
    cast: ['Donald Glover', 'Beyoncé', 'Seth Rogen', 'James Earl Jones'],
